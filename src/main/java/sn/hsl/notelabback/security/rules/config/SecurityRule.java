package sn.hsl.notelabback.security.rules.config;
...
public class SecurityRule {
    ...
    public void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        if (access.isEmpty()) {
            ...
            httpSecurity.authorizeRequests(request -> request
                    .requestMatchers(httpMethod, apiPatterns.toArray(new String[]{}))
                    .permitAll());
        } else {
    ...
    public class Condition {
         ...
         * @return
         */
        public Condition hasPermission(Permissions permission) {
        ...
        private String toFormat() {
            ...
            if (!this.permissions.isEmpty()) {
                String anyAuthorities = this.permissions.stream()
                        .map(r -> "T(" + Permissions.class.getName() + ")." + r.name())
